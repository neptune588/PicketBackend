...
public class BoardController {
    ...
    public Slice<BoardResponseDTO> boardList(GetBoardListRequestDTO getBoardListRequestDTO) {
    ...
    public ResponseEntity<SuccessResponse> boardAdd(
            @RequestPart("dto") PostBoardRequestDTO postBoardRequestDTO,
    ...
    public ResponseEntity<SuccessResponse> update(@PathVariable Long boardId, @RequestBody PatchBoardRequestDTO patchBoardDTO) {
