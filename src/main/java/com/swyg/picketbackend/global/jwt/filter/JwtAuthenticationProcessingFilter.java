package com.swyg.picketbackend.global.jwt.filter;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    private static final String NO_CHECK_URL = "/login"; // 로그인 요청은 Filter 적용 X

    private final JwtService jwtService;

    private final UserRepository userRepository;

    private GrantedAuthoritiesMapper authoritiesMapper = new NullAuthoritiesMapper(); // 인증된 사용자의 권한 매핑
     ...
     * UserDetails의 User 객체 안에 Set authorities이 있어서 getter로 호출한 후에,
